...
TRAIN_SET_PATH="/home/jovyan/AndreiZ/MARL/TatyanaG/swarm_data_centered_npy" # preprocess data using #data_process.sh
#TRAIN_SET_PATH="$HOME/swarm_data_centered_npy"
